		    ...
		    <nav class="navbar">
		      <div class="container">
		        <div class="navbar-header">
		          ...
		          <a class="navbar-brand" href="index.php"><img src="assets/img/logo-header.png" class="logo">  </a>
		        </div>
		        <div id="navbar" class="collapse navbar-collapse">
		          <ul class="nav nav-pills navbar-nav navbar-right text-center">
		            <li class="active"><a href="index.php" class="lh40">Lord Cochrane</a></li>
		            <li><a href="page-alojamientos.php">Tipos de<br>Alojamientos</a></li>
		            <li><a href="page-padres.php">Padres y futuros<br>residentes</a></li>
		            <li><a href="page-comunidad.php" class="lh40">Comunidad</a></li>
		          </ul>
		        </div><!--/.nav-collapse -->
		      </div>
		    </nav>
